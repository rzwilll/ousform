...
<div class="report-content">
                    <table>
                        <tr>
                            ...
                            <td>{{ $program_name->program_name }}</td>
                        </tr>
                        <tr>
                            <td><b>Department:</b></td>
                            <td> {{ $program_name->department_name }}</td>
                        </tr>
                        <tr>
                            <td><b>Academic Year:</b></td>
                            <td>{{ $report_academic_year->school_year }}</td>
                        </tr>
                        <!-- <tr>
                        ...
                        <tr>
                            ...
                            <td>{{  date('M d, Y', strtotime($report_academic_year->created_at)) }}</td>
                        </tr>
                        <tr>
                    ...
                    <form action="">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>{{ $total_enroled }} out of {{ $total_program_enrolees }}</td>
                                <td><b>Number of Students with INC:</b></td>
                                <td>{{ $total_grade_INC }}</td>
                            </tr>
                            <tr>
                                @php
